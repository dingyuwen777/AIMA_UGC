"""Excel Import Job 的当前版本化 Payload 与共享 Runtime 注册。"""
...
IMPORT_JOB_TYPE = "ingestion.import-excel.v2"
IMPORT_JOB_PAYLOAD_VERSION = "ingestion.import-excel.v2"
IMPORT_JOB_TIMEOUT_SECONDS = 1800
IMPORT_JOB_MAX_ATTEMPTS = 10


class ImportJobPayload(BaseModel):
    """当前 Excel Import 只携带冻结 Brand/Vehicle Filter Snapshot。"""
...
def register_import_job(
    ...
    *,
    ...
    """只注册当前 v2 Import Job；旧任务不再属于批准兼容面。"""
