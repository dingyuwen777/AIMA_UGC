...
2. **`user_voice` vs `dealer_promotion`**
   ...
   - 即使门店销售使用第一人称，只要主要目的是获客成交，也不是 `user_voice`。
...
7. **`unknown` 的使用**
   ...
   - 作者资料缺失不等于必须 `unknown`：如果标题/正文已经清楚显示个人体验、门店获客、媒体报道等目的，应按内容证据正常分类。
