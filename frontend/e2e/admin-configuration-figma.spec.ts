...
test('brand and vehicle create dialogs do not expose internal code controls', async ({ page }) => {
  await mockAdmin(page)
  await page.goto('/admin/configuration')
