...
- [`AIMA持续开发与内网上线通用提示词.md`](AIMA持续开发与内网上线通用提示词.md)：用于新的 ChatGPT/GitHub Coding Agent 会话；固定提示词本身不保存 SHA、PR 或当前 Stage 状态，而是要求每次从当前 `main`、Active Change、Roadmap 和机器事实重新判断下一最小正式单元，持续推进 Stage 8F、内网 V1 和后续 Production Hardening。
...
- [`AIMA持续开发与内网上线通用提示词.md`](AIMA持续开发与内网上线通用提示词.md)
