...
基础已经完成，Stage 2—4 尚未实现；当前事实仍以代码、Contract、Schema/Migration、测试和
Blueprint 为准。本文只批准一个最小增量方向：
...
即 Mapping 与当前 Brand/Vehicle Filter 在同一转换阶段完成。
...
| Stage 2 Excel 持久 Canonical | planned | Stage 1 | 单文件 + Historical/Data Import 在 Filter 前持久 Canonical |
