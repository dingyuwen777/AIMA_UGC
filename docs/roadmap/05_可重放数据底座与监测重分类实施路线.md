...
| Stage | 当前状态 | 依赖 | 核心结果 |
| --- | --- | --- | --- |
| Stage 1 Canonical Artifact 基础 | planned | 当前 Brand/Vehicle Filter 基线已完成 | 共用 JSONL.gz Writer/Reader + Artifact/lineage 最小 Contract |
| Stage 2 Excel 持久 Canonical | blocked | Stage 1 | 单文件 + Historical/Data Import 在 Filter 前持久 Canonical |
| Stage 3 TikHub 持久 Canonical | blocked | Stage 1 + 当前 Filter 基线 | Discovery 最终 Filter 输入 Canonical 持久化 |
