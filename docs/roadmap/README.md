...
4. [`docs/roadmap/05_可重放数据底座与监测重分类实施路线.md`](05_可重放数据底座与监测重分类实施路线.md)：Roadmap 04 完成后，把 Raw/Canonical/Monitoring Filter 演进为可恢复、可重放、可版本化重分类的数据底座，同时允许年度 Content 上的车型组共现、新 UI、报表和专题分析并行开发。
