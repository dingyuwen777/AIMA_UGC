...
- [`03_4000万历史数据迁移实施方案.md`](03_4000万历史数据迁移实施方案.md)：**当前近期开发的正式执行计划**。Internal V1-B 已由业务 Owner 于 2026-08-26 确认完成；Stage 12 软件工作区已完成统一“导入数据”Campaign（本地电脑/服务器批准目录、标准观测/历史补空）、逐行对账与网页手动 AI Run 的本地验收，待 Git 集成、公司服务器容量演练和独立生产授权。
