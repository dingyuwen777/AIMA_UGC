...
- [`backend/src/aima_ugc/bootstrap/analysis_worker.py`](../../backend/src/aima_ugc/bootstrap/analysis_worker.py)：把 Analysis Request、LLM、Validator、Persistence 串成正式 Job Executor
