...
| `collection` | Plan、Occurrence、Run、Scope、Provider Request/Attempt、Candidate、Decision | [`modules/collection/README.md`](../../backend/src/aima_ugc/modules/collection/README.md) |
| `content` | Canonical Ingestion、Content/Comment Current、Version、Metric、Query | [`modules/content/README.md`](../../backend/src/aima_ugc/modules/content/README.md)、[`content/ingestion.py`](../../backend/src/aima_ugc/modules/content/ingestion.py) |
| `ingestion` | Excel Import Batch、Import Job、文件入口父事实 | [`modules/ingestion/README.md`](../../backend/src/aima_ugc/modules/ingestion/README.md) |
| `analysis` | AI relevance、voice_type、sentiment、labels、Analysis Request/Result | [`modules/analysis/README.md`](../../backend/src/aima_ugc/modules/analysis/README.md) |
