...
人类可读的五平台查询附录见 [`docs/blueprint/10-TikHub真实响应结构附录.md`](../../../../docs/blueprint/10-TikHub真实响应结构附录.md)。多 API family 的验证与备用判定见 [`docs/blueprint/11-04_TikHub多接口验证与备用策略.md`](../../../../docs/blueprint/11-04_TikHub多接口验证与备用策略.md)。
