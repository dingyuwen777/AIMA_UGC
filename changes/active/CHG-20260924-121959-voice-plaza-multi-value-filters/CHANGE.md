...
| 设计与视觉基线 | 移除内容类型/相关性/竞争范围筛选，数量显示移至分页区（空列表保留“共 0 条”） | Owner 决定 | 同步更新 docs/guides/01 §7.2 与 voice-plaza-design.spec.ts，Figma 待同步 |
...
- **长期文档**：同步更新 `docs/guides/01_Figma与前端设计开发工作流.md` §7.2，记录声音广场筛选维度与数量显示位置变更（Owner 批准，Figma 待同步）。
