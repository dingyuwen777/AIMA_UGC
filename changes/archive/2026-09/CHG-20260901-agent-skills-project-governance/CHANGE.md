...
| R6 | 不手工迁移 legacy v3 Runtime/manifest/managed block；正式升级留给后续 Agent_Skills Release | user:2026-09-01-agent-skills-release-ownership | satisfied | PR changed files 不包含 installer-owned .agents Runtime/manifest/managed asset；AGENTS managed block 未手工迁移，项目治理 gate success。 |
