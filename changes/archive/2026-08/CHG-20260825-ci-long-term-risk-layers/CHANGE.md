...
| R5 | 测试层只证明真实边界，Real Full-stack/Provider Probe 不被替代或夸大 | .agents/skills/coding/references/08_分层测试与验收策略.md | satisfied | PR Full-stack `32793422454` 与 post-merge Full-stack `32793732230` 独立成功；Provider Probe 因未修改 Provider endpoint/shape/capability 保持 not_applicable，未进入普通 CI |
